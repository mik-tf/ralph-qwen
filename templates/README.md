# Ralph-Qwen Templates

This directory contains project templates for the enhanced Ralph-Qwen workflow.

## Available Templates

### 1. Generic Template (`generic/`)
A basic template for general-purpose Ralph projects.
...
- `prompt.md` - Initial prompt for the Ralph agent
